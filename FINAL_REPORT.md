...
### Core Features
![Core Features](app/static/images/core-features.png)
...
- Flask user sessions and authentication for login/logout functionality and access to user features
...
- Create Account and Edit Profile:

![Profile](app/static/images/profile.png)

- Browse Courses, view course statistics, and read reviews:
...
![Course Review](app/static/images/reviews.png)
...
### Use case #1: Home page loads current data for the logged-in user
...
### Use case #2: Submit a user-written course review to the platform
...
### Use case #3: Add a new course to the platform
...
5. Hitting 'submit' should redirect the user to the newly-created course page.
...
#### 2. Technical Dependencies and Time Zones
...
#### 3. Team Collaboration and Problem-Solving
